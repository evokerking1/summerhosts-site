...
- These regexes to replace dates from the old system to the new. For the find thing: `\{new Date\((\d+)\)\.(toLocaleString|toLocaleTimeString)\(\)\}` for the replace thing: `<DateDisplay timestamp="$1" />`
